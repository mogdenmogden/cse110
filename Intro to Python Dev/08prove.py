...
image_beach = Image.open(
    "C:\\Users\\mogde\\Desktop\\SCHOOL\\cse110\\cse110_images\\beach.jpg")
...
green_penguin = Image.open(
    "C:\\Users\\mogde\\Desktop\\SCHOOL\\cse110\\cse110_images\\penguin.jpg")
...
green_penguin.save(
    "C:\\Users\\mogde\\Desktop\\SCHOOL\\cse110\\cse110_images\\beach_penguin.jpg")
...
green_hiker = Image.open(
    "C:\\Users\\mogde\\Desktop\\SCHOOL\\cse110\\cse110_images\\hiker.jpg")
...
green_hiker.save(
    "C:\\Users\\mogde\\Desktop\\SCHOOL\\cse110\\cse110_images\\beach_hiker.jpg")
...
hiker_peng_beach.save(
    "C:\\Users\\mogde\\Desktop\\SCHOOL\\cse110\\cse110_images\\hiker_peng_beach.jpg")
hiker_peng_beach = Image.open(
    "C:\\Users\\mogde\\Desktop\\SCHOOL\\cse110\\cse110_images\\hiker_peng_beach.jpg")
hiker_peng_beach.show()


# Combine beach hiker and beach penguin by comparing values (no ghost effect)
# One image on top of another, not averaged.
no_ghost_beach = Image.new("RGB", image_beach.size)
pixels_no_ghost = no_ghost_beach.load()

for y in range(0, 600):
    for x in range(0, 800):
        (r0, g0, b0) = pixels_beach[x, y]
        (r, g, b) = pixels_green_hiker[x, y]
        (r2, g2, b2) = pixels_green_penguin[x, y]
        if pixels_green_hiker[x, y] != pixels_beach[x, y]:
            pixels_no_ghost[x, y] = (r, g, b)
        else:
            pixels_no_ghost[x, y] = (r0, g0, b0)
...
for y in range(0, 600):
    for x in range(0, 800):
        ...
        (r, g, b) = pixels_green_hiker[x, y]
        (r2, g2, b2) = pixels_green_penguin[x, y]
        if pixels_green_penguin[x, y] != pixels_beach[x, y]:
            pixels_no_ghost[x, y] = (r2, g2, b2)
        else:
            pass

no_ghost_beach.save(
    "C:\\Users\\mogde\\Desktop\\SCHOOL\\cse110\\cse110_images\\no_ghost_beach.jpg")
no_ghost_beach = Image.open(
    "C:\\Users\\mogde\\Desktop\\SCHOOL\\cse110\\cse110_images\\no_ghost_beach.jpg")
no_ghost_beach.show()
...
# image_original.save(
#     "C:\\Users\\mogde\\Desktop\\SCHOOL\\cse110\\cse110_images\\the_file_goes_here_2nd.jpg")
